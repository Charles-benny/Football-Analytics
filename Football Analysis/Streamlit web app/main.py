...
def main():
    ...
    st.title("Analysis Using Team Prediction & Tactical Map")
    st.subheader("---Akash")

    st.sidebar.title("Team Names")
    ...
    with tab1:
        st.header("Handling Steps!")
        
    
        st.markdown("""
                    1. Upload a video to analyze
                    2. Using the sidebar menu "Browse files" button.
                    3. Enter the team names in the text fields in the sidebar menu.
                    4. Access the "Team colors" tab on the main page.
                    5. Select a frame where players and goalkeepers from both teams can be detected.
                    6. Pick each team color.
                    7. Go to the "Model Hyperparameters & Detection" tab.
                    8. Adjust hyperparameters and select the annotation options.
